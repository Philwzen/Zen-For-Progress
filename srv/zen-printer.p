...
&glob Table-name zen-printer     /* name of table we are using */
...
&IF DEFINED(EXCLUDE-get-printers) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE get-printers Procedure 
