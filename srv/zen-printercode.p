...
&glob Table-name zen-printercode     /* name of table we are using */
...
********************************************************/
def var lv-physicaltype as char no-undo.
{{&core}apsrv-getrecords.i
  &where = "where zen-PrinterCode.PhysicalType = lv-physicaltype"}
