...
def input param pv-widget as char no-undo.
   ...
   {{&core}apsrv-getrecords.i &whereclause  = 
"where Zen-WidgetProperty.pgm = pv-parent
   and zen-widgetproperty.widframe = pv-frame
   and zen-widgetproperty.wid-name = pv-widget"}
