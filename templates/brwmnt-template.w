...
&glob table-name zen-dpgm /* change this to be your tablename */
...
&Scoped-define FIELDS-IN-QUERY-br-maint t-zen-dpgm.author ~
t-zen-dpgm.Description t-zen-dpgm.editgroups 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-maint 
&Scoped-define QUERY-STRING-br-maint FOR EACH t-zen-dpgm NO-LOCK
&Scoped-define OPEN-QUERY-br-maint OPEN QUERY br-maint FOR EACH t-zen-dpgm NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br-maint t-zen-dpgm
&Scoped-define FIRST-TABLE-IN-QUERY-br-maint t-zen-dpgm
...
&Scoped-Define DISPLAYED-FIELDS t-zen-dpgm.dataguess t-zen-dpgm.author ~
t-zen-dpgm.cryfilename 
...
&Scoped-define add-list t-zen-dpgm.dataguess t-zen-dpgm.author ~
t-zen-dpgm.cryfilename 
&Scoped-define edit-list t-zen-dpgm.dataguess t-zen-dpgm.author ~
t-zen-dpgm.cryfilename 
...
DEFINE FRAME a-frame-maint
     ...
     t-zen-dpgm.dataguess AT ROW 15 COL 21 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 17.4 BY 1
     t-zen-dpgm.author AT ROW 15 COL 64 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 22 BY 1
     t-zen-dpgm.cryfilename AT ROW 16 COL 21 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 27 BY 1
...
/* SETTINGS FOR FILL-IN t-zen-dpgm.author IN FRAME a-frame-maint
   NO-ENABLE 1 2                                                        */
/* SETTINGS FOR FILL-IN t-zen-dpgm.cryfilename IN FRAME a-frame-maint
   NO-ENABLE 1 2                                                        */
/* SETTINGS FOR FILL-IN t-zen-dpgm.dataguess IN FRAME a-frame-maint
   NO-ENABLE 1 2                                                        */
...
/* Query rebuild information for BROWSE br-maint
     ...
     _FldNameList[1]   = Temp-Tables.t-zen-dpgm.author
     _FldNameList[2]   = Temp-Tables.t-zen-dpgm.Description
     _FldNameList[3]   = Temp-Tables.t-zen-dpgm.editgroups
     _Query            is NOT OPENED
*/  /* BROWSE br-maint */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  IF AVAILABLE t-zen-dpgm THEN 
    DISPLAY t-zen-dpgm.dataguess t-zen-dpgm.author t-zen-dpgm.cryfilename 
      WITH FRAME a-frame-maint.
  ENABLE br-maint btn-orders 
      WITH FRAME a-frame-maint.
