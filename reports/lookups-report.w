...
&Scoped-Define ENABLED-OBJECTS FILL-IN-params 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-params 

/* Custom List Definitions                                              */
/* List-1,List-2,List-3,List-4,List-5,List-6                            */
&Scoped-define List-1 FILL-IN-params 
...
def var FILL-IN-params as char FORMAT "X(256)":U INITIAL "*" 
     LABEL "Lookup" 
     VIEW-AS FILL-IN 
...
assign
   ...
   lv-paramtitles = 'Lookup'.

/********************** End Custom Bit  ****************************/

/* extract to run is defined in program record on db */
{{&core}{&rep}doreport.i}
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-params 
      WITH FRAME f-main.
  ENABLE FILL-IN-params 
      WITH FRAME f-main.
