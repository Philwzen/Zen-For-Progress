...
DEFINE TEMP-TABLE t-zen-PrinterCode NO-UNDO LIKE zen-PrinterCode.
...
&glob table-name zen-printerCode
...
&Scoped-define INTERNAL-TABLES t-zen-PrinterCode

/* Definitions for BROWSE br-maint                                      */
&Scoped-define FIELDS-IN-QUERY-br-maint t-zen-PrinterCode.PhysicalType ~
t-zen-PrinterCode.CodeName 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-maint 
&Scoped-define QUERY-STRING-br-maint FOR EACH t-zen-PrinterCode NO-LOCK
&Scoped-define OPEN-QUERY-br-maint OPEN QUERY br-maint FOR EACH t-zen-PrinterCode NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br-maint t-zen-PrinterCode
&Scoped-define FIRST-TABLE-IN-QUERY-br-maint t-zen-PrinterCode
...
&Scoped-Define DISPLAYED-FIELDS t-zen-PrinterCode.PhysicalType ~
t-zen-PrinterCode.CodeName 
&Scoped-define DISPLAYED-TABLES t-zen-PrinterCode
&Scoped-define FIRST-DISPLAYED-TABLE t-zen-PrinterCode


/* Custom List Definitions                                              */
/* add-list,edit-list,List-3,List-4,List-5,List-6                       */
&Scoped-define add-list t-zen-PrinterCode.PhysicalType 
&Scoped-define edit-list t-zen-PrinterCode.CodeName 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-maint window-maint _STRUCTURED
  QUERY br-maint NO-LOCK DISPLAY
      t-zen-PrinterCode.PhysicalType FORMAT "x(30)":U
      t-zen-PrinterCode.CodeName FORMAT "x(50)":U WIDTH 43.8
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS SIZE 79 BY 10.52 FIT-LAST-COLUMN.
...
DEFINE FRAME a-frame-maint
     ...
     t-zen-PrinterCode.PhysicalType AT ROW 13 COL 20 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 56 BY 1
     t-zen-PrinterCode.CodeName AT ROW 14 COL 20 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 56 BY 1
     btn-Codes AT ROW 15.52 COL 39
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: t-zen-PrinterCode T "?" NO-UNDO dive zen-PrinterCode
   END-TABLES.
 */
...
/* SETTINGS FOR FILL-IN t-zen-PrinterCode.CodeName IN FRAME a-frame-maint
   NO-ENABLE 2                                                          */
/* SETTINGS FOR FILL-IN t-zen-PrinterCode.PhysicalType IN FRAME a-frame-maint
   NO-ENABLE 1                                                          */
...
/* Query rebuild information for BROWSE br-maint
     _TblList          = "Temp-Tables.t-zen-PrinterCode"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST OUTER, FIRST OUTER,"
     _FldNameList[1]   > Temp-Tables.t-zen-PrinterCode.PhysicalType
"t-zen-PrinterCode.PhysicalType" ? "x(30)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.t-zen-PrinterCode.CodeName
"t-zen-PrinterCode.CodeName" ? "x(50)" "character" ? ? ? ? ? ? no ? no no "43.8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is NOT OPENED
*/  /* BROWSE br-maint */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  IF AVAILABLE t-zen-PrinterCode THEN 
    DISPLAY t-zen-PrinterCode.PhysicalType t-zen-PrinterCode.CodeName 
