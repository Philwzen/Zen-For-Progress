...
DEFINE TEMP-TABLE t-zen-PrinterFormDetail NO-UNDO LIKE zen-PrinterFormDetail.
...
&glob table-name zen-printerFormdetail
...
&Scoped-define INTERNAL-TABLES zen-PrinterFormDetail

/* Definitions for BROWSE br-maint                                      */
&Scoped-define FIELDS-IN-QUERY-br-maint ~
zen-PrinterFormDetail.zen-printerformtableid ~
zen-PrinterFormDetail.zen-printercodetableid 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-maint 
&Scoped-define QUERY-STRING-br-maint FOR EACH zen-PrinterFormDetail NO-LOCK
&Scoped-define OPEN-QUERY-br-maint OPEN QUERY br-maint FOR EACH zen-PrinterFormDetail NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br-maint zen-PrinterFormDetail
&Scoped-define FIRST-TABLE-IN-QUERY-br-maint zen-PrinterFormDetail
...
DEFINE QUERY br-maint FOR 
      zen-PrinterFormDetail SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-maint window-maint _STRUCTURED
  QUERY br-maint NO-LOCK DISPLAY
      zen-PrinterFormDetail.zen-printerformtableid FORMAT ">>>>>>>>>>>9":U
      zen-PrinterFormDetail.zen-printercodetableid FORMAT ">>>>>>>>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: t-zen-PrinterFormDetail T "?" NO-UNDO dive zen-PrinterFormDetail
   END-TABLES.
 */
...
/* Query rebuild information for BROWSE br-maint
     _TblList          = "dive.zen-PrinterFormDetail"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST OUTER, FIRST OUTER,"
     _FldNameList[1]   = dive.zen-PrinterFormDetail.zen-printerformtableid
     _FldNameList[2]   = dive.zen-PrinterFormDetail.zen-printercodetableid
     _Query            is NOT OPENED
*/  /* BROWSE br-maint */
&ANALYZE-RESUME
